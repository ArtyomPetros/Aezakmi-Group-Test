...
class CanvasViewController<T: PKCanvasView>: UIViewController, PKToolPickerObserver, PKCanvasViewDelegate, UIGestureRecognizerDelegate, UITextViewDelegate {
    ...
    @objc func handleLongPress(_ recognizer: UIGestureRecognizer) {
        ...
        if let view = recognizer.view, let superview = view.superview {
            ...
            UIMenuController.shared.menuItems = [
                ...
                UIMenuItem(title: "Редактировать", action: #selector(editView)),
                UIMenuItem(title: "Дублировать", action: #selector(duplicateView)),
                UIMenuItem(title: "Удалить", action: #selector(deleteView))
            ]
    ...
    func editTextView(_ view: UILabel) {
        self.showTextAlert(title: "Редактировать", text: view.text, actionTitle: "Сохранить") { text in
            view.text = text
